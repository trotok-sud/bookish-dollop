...
contract SNG is ERC20, Ownable {
    ...
    constructor() ERC20("SNG Token", "SNG") {
        address router;
        address pinkLock;
        ...
        feeOnTransfer = 0;
        transferOwnership(0xA9C8a2207B1C7D42DC3d95d8bCA6658789B6dc52);
        feeReceiver = 0xa91A480AAc26F68F6BBaeAa7984F096Af787c203;
